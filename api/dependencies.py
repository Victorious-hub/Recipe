...
class Container(containers.DeclarativeContainer):
    ...
    client = providers.Singleton(Client, base_url=base_api_url, handlers=handlers)

    mock_client = providers.Singleton(MockClient, base_url=base_api_url, handlers=handlers)
